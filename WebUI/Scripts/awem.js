awem = function ($) {
    ...
    function odropdown(o, opt) {
        ...
        function markeMenuSelectedItems() {
            var val = awe.val(o.v);
            var items = o.lrs;
        ...
        o.modo = { dropmenu: $dropmenu, inputCont: $inputCont, odisplay: $odisplay, caption: caption, odropdown: $odropdown };
